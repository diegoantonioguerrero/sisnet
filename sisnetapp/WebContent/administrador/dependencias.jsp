    ...
    try{
        ...
        if (manejadorSesion_local.getSesion() != ConstantesGeneral.VALOR_NULO){
             ...
             if (manejadorSesion_local.obtenerTablaActual() != ConstantesGeneral.VALOR_NULO){
                 pagina_local = generadorPaginaAplicacion_local.obtenerPaginaDependencias();
             } else {
                 pagina_local = generadorPaginaAplicacion_local.obtenerPaginaDependienteHabilitacion();
             }
