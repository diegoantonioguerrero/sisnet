...
RowCM				: "행(Row)",
ColumnCM			: "열(Column)",
InsertRowAfter		: "뒤�? 행 삽입",
InsertRowBefore		: "앞�? 행 삽입",
DeleteRows			: "가로줄 삭제",
InsertColumnAfter	: "뒤�? 열 삽입",
InsertColumnBefore	: "앞�? 열 삽입",
DeleteColumns		: "세로줄 삭제",
InsertCellAfter		: "뒤�? 셀/칸 삽입",
InsertCellBefore	: "앞�? 셀/칸 삽입",
DeleteCells			: "셀 삭제",
MergeCells			: "셀 합치기",
MergeRight			: "오른쪽 뭉치기",
MergeDown			: "왼쪽 뭉치기",
HorizontalSplitCell	: "수�?� 나누기",
VerticalSplitCell	: "수�? 나누기",
TableDelete			: "표 삭제",
CellProperties		: "셀 �?성",
TableProperties		: "표 �?성",
...
NoActiveX			: "브러우저�?� 보안 설정으로 �?�해 몇몇 기능�?� 작�?��? 장애가 있�?� 수 있습니다. \"액티브-액스 기능과 플러그 �?�\" 옵션�?� 허용하여 주시지 않으면 오류가 발�?할 수 있습니다.",
BrowseServerBlocked : "브러우저 요소가 열리지 않습니다. �?업차단 설정�?� 꺼져있는지 확�?�하여 주십시오.",
DialogBlocked		: "윈�?�우 대화창�?� 열 수 없습니다. �?업차단 설정�?� 꺼져있는지 확�?�하여 주십시오.",
...
DlnLnkMsgInvPopName	: "�?업창�?� 타�?�틀�?� 공백�?� 허용하지 않습니다.",
...
DlgPasteSec		: "브러우저 보안 설정으로 �?�해, �?�립보드�?� �?료를 �?접 접근할 수 없습니다. �?� 창�? 다시 붙여넣기 하십시오.",
...
DlgAboutVersion		: "버전",
DlgAboutInfo		: "�?� 많�?� 정보를 보시려면 다�?� 사�?�트로 가십시오.",
