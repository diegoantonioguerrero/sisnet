...
Copy				: "Kopírovat",
Paste				: "Vložit",
PasteText			: "Vložit jako �?istý text",
...
NumberedList		: "Vložit/odstranit �?íslovaný seznam",
...
Done				: "Hotovo",
PasteWordConfirm	: "Jak je vidět, vkládaný text je kopírován z Wordu. Chcete jej před vložením vy�?istit?",
NotCompatiblePaste	: "Tento příkaz je dostupný pouze v Internet Exploreru verze 5.5 nebo vyšší. Chcete vložit text bez vy�?ištění?",
...
NoActiveX			: "Nastavení bezpe�?nosti Vašeho prohlíže�?e omezuje funk�?nost některých jeho možností. Je třeba zapnout volbu \"Spouštět ovládáací prvky ActiveX a moduly plug-in\", jinak nebude možné využívat všechny dosputné schopnosti editoru.",
...
DlgGenAccessKey		: "Přístupový klí�?",
DlgGenName			: "Jméno",
...
DlgCellVerAlignBaseline	: "Na ú�?aří",
DlgCellRowSpan		: "Slou�?ené řádky",
...
PasteErrorCut	: "Bezpe�?nostní nastavení Vašeho prohlíže�?e nedovolují editoru spustit funkci pro vyjmutí zvoleného textu do schránky. Prosím vyjměte zvolený text do schránky pomocí klávesnice (Ctrl+X).",
PasteErrorCopy	: "Bezpe�?nostní nastavení Vašeho prohlíže�?e nedovolují editoru spustit funkci pro kopírování zvoleného textu do schránky. Prosím zkopírujte zvolený text do schránky pomocí klávesnice (Ctrl+C).",

PasteAsText		: "Vložit jako �?istý text",
...
DlgPasteSec		: "Z důvodů nastavení bezpe�?nosti Vašeho prohlíže�?e nemůže editor přistupovat přímo do schránky. Obsah schránky prosím vložte znovu do tohoto okna.",
...
DlgDocCharSetCT		: "Tradi�?ní �?ínština (Big5)",
DlgDocCharSetCR		: "Cyrilice",
DlgDocCharSetGR		: "Ře�?tina",
...
DlgTemplatesLoading	: "Nahrávám přeheld šablon. Prosím �?ekejte...",
