...
ColumnCM			: "欄",
InsertRowAfter		: "�?�下�?�入列",
InsertRowBefore		: "�?�上�?�入列",
DeleteRows			: "刪除列",
InsertColumnAfter	: "�?��?��?�入欄",
InsertColumnBefore	: "�?�左�?�入欄",
DeleteColumns		: "刪除欄",
InsertCellAfter		: "�?��?��?�入儲存格",
InsertCellBefore	: "�?�左�?�入儲存格",
DeleteCells			: "刪除儲存格",
MergeCells			: "�?�併儲存格",
MergeRight			: "�?��?��?�併儲存格",
MergeDown			: "�?�下�?�併儲存格",
HorizontalSplitCell	: "橫�?�分割儲存格",
VerticalSplitCell	: "縱�?�分割儲存格",
TableDelete			: "刪除表格",
...
FontFormats			: "一般;已格�?化;�?�?�;標題 1;標題 2;標題 3;標題 4;標題 5;標題 6;一般 (DIV)",
...
VisitLinkBlocked	: "無法開啟新視窗，請確定所有快顯視窗�?鎖程�?是�?�關閉",
...
DlnLnkMsgInvPopName	: "快顯�??稱必須以「英文字�?�?為開頭，且�?得�?�有空白",
...
DlgPasteSec		: "因為�?覽器的安全性設定，本編輯器無法直接存�?�您的剪貼簿資料，請您自行在本視窗進行貼上動作。",
...
DlgButtonTypeSbm	: "�?出 (Submit)",
DlgButtonTypeRst	: "�?設 (Reset)",
...
DlgTemplatesReplace	: "�?�代原有內容",

// About Dialog
DlgAboutAboutTab	: "關於",
DlgAboutBrowserInfoTab	: "�?覽器資訊",
DlgAboutLicenseTab	: "許�?�證",
DlgAboutVersion		: "版本",
