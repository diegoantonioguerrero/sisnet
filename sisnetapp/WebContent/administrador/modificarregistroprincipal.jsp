...
<%  Pagina pagina_local = null;
    ...
    try{
        ...
        if(manejadorSesion_local.getSesion() != ConstantesGeneral.VALOR_NULO){
            ...
            pagina_local = generadorPaginaAplicacion_local.obtenerPaginaModificarRegistroPrincipal(
                    manejadorSesion_local.obtenerGrupoInformacionActual(), 
                    manejadorSesion_local.obtenerValorLlavePrimaria());
