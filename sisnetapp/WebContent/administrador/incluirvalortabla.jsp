...
<%  boolean esModificacion_local = ConstantesGeneral.VALOR_FALSO;
    ...
    try {
        ...
        if (manejadorSesion_local.getSesion() != ConstantesGeneral.VALOR_NULO){
            ...
            if(manejadorSesion_local.obtenerTablaDepende() == ConstantesGeneral.VALOR_NULO){
                pagina_local = generadorPaginaAplicacion_local.obtenerPaginaIncluirValorTabla(esModificacion_local);
            } else {
                if(manejadorSesion_local.obtenerTablaActual() == ConstantesGeneral.VALOR_NULO){
                    pagina_local = generadorPaginaAplicacion_local.obtenerPaginaIncluirDependienteHabilitacion(esModificacion_local);
                } else {
                    pagina_local = generadorPaginaAplicacion_local.obtenerPaginaIncluirValorDependiente(esModificacion_local);
                }
            }
