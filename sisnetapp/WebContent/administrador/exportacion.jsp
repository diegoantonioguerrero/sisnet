...
<%  Pagina pagina_local = null;
    ...
    try{
        ...
        if (manejadorSesion_local.getSesion() != ConstantesGeneral.VALOR_NULO){
            ...
            pagina_local = generadorPaginaAplicacion_local.obtenerPaginaExportacion((manejadorSesion_local.obtenerAccion() == 
                    ConstantesAdministrador.const_AccionExportarReporte));
