...
{
  public Version33(ObjetoConexionBaseDatos pObjetoConexionBaseDatos) {
    super(pObjetoConexionBaseDatos);
  }
  private ListaCadenas obtenerListadoInstruccionesSqlActualizarCamposVersion33() {
    ListaCadenas listaCadenas_local = null;
    
    try {
      listaCadenas_local = new ListaCadenas();
      if (!verificarExistenciaCampo("fldidaplicacionimpresionmasiva", "APLICACION"))
      {
        listaCadenas_local.adicionar("alter table aplicacion add fldidaplicacionimpresionmasiva integer default 0");
      }
    }
  ...
  public void actualizarBaseDatosSisnetVersion33() {
    ...
    try {
      ...
      listaCadenas_local = obtenerListadoInstruccionesSqlActualizarCamposVersion33();
...
/* Location:              D:\Personal\sisnet\sisnetMasterApp\sisnetapp.war!\WEB-INF\classes\com\sisnet\version\Version33.class
