...
public class GeneradorPagina
{
    ...
    protected String obtenerBloqueHeadPagina(ListaCampo pListaCampo, String pNombreFormulario, int pNivelesAnterioresDirectorio, boolean pExisteActuacion, boolean pEsSoloConsulta)
    {
        ...
        try
        {
            ...
            stringBuffer_local.append(getGeneradorComponentesHtml().incluirLibreriaJavascript("../utilidades/javascript/", "sisnet.js?v=1.1", pNivelesAnterioresDirectorio));
...
private String obtenerEncabezadoPaginaSisnet(boolean pExisteConexion)
{
    ...
    try
    {
        ...
        encabezadoPagina_local = mc.concatenarCadena(encabezadoPagina_local, getGeneradorComponentesHtml().incluirLibreriaJavascript("../utilidades/javascript/", "sisnet.js?v=1.1", 0));
