...
public class GeneradorPagina
{
    ...
    private String conformarJavascriptValidarConfiguracionCalculos(GrupoInformacion pGrupoInformacion)
    {
        ...
        try
        {
            campoValorNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldidcampovalor") + ".style.display='none';\n \t";
            campoValorVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldidcampovalor") + ".style.display='inline';\n \t";
            campoRecalculableNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldesrecalculable") + ".style.display='none';\n \t";
            campoRecalculableVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldesrecalculable") + ".style.display='inline';\n \t";
            campoOrigenUnoNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldidcampoorigenuno") + ".style.display='none';\n \t";
            campoOrigenUnoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldidcampoorigenuno") + ".style.display='inline';\n \t";
            campoFormatoOrigenUnoNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldformatocampoorigenuno") + ".style.display='none';\n \t";
            campoFormatoOrigenUnoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldformatocampoorigenuno") + ".style.display='inline';\n \t";
            campoOrigenDosNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldidcampoorigendos") + ".style.display='none';\n \t";
            campoOrigenDosVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldidcampoorigendos") + ".style.display='inline';\n \t";
            campoFormatoOrigenDosNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldformatocampoorigendos") + ".style.display='none';\n \t";
            campoFormatoOrigenDosVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldformatocampoorigendos") + ".style.display='inline';\n \t";
            campoFormatoCampoCalculadoNoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldformatocampocalculado") + ".style.display='none';\n \t";
            campoFormatoCampoCalculadoVisible_local = "frmIncluir." + mc.convertirAMayusculas("fldformatocampocalculado") + ".style.display='inline';\n \t";
		
            javascriptValidarConfiguracion_local += "function validarConfiguracionCalculos(){ \n\t try{\n ";  
			javascriptValidarConfiguracion_local += "var frmIncluir = document.formularioIncluir;\n";
			javascriptValidarConfiguracion_local += "var seleccion_local = parseInt(frmIncluir." + mc.convertirAMayusculas("fldcampocalculado") + "[frmIncluir" + '.' + mc.convertirAMayusculas("fldcampocalculado") + ".selectedIndex].value);\n";
            javascriptValidarConfiguracion_local += "limpiarLista (frmIncluir." + mc.convertirAMayusculas("fldidcampovalor") + ");\n";
            javascriptValidarConfiguracion_local += "limpiarLista (frmIncluir." + mc.convertirAMayusculas("fldidcampoorigenuno") + ");\n";
            javascriptValidarConfiguracion_local += "limpiarLista (frmIncluir." + mc.convertirAMayusculas("fldidcampoorigendos") + ");\n";
            javascriptValidarConfiguracion_local += "switch(seleccion_local){\n";
            javascriptValidarConfiguracion_local += "case 1: " + campoValorNoVisible_local + campoRecalculableNoVisible_local + campoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoCampoCalculadoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoFormatoOrigenDosNoVisible_local + " break; \n";
            javascriptValidarConfiguracion_local += "case 2: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "cambiarCampoValor(); break; \n";
            javascriptValidarConfiguracion_local += "case 3: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposGruposMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 4: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposGruposMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 5: \ncase 6: \n\t" + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); \n \t" + "obtenerlistaCamposFechaAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 7: \ncase 8: \ncase 43: \n\t" + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 9: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosGruposMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 10: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosMismoGrupo(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 11: " + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerListaCamposAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + ");  \n \t" + "obtenerListaCamposAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigendos") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 12: " + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerListaCamposAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); \n \t" + "obtenerListaCamposAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigendos") + "); break; \n \t";
            javascriptValidarConfiguracion_local += "case 13: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 14: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 15: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 16: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 17: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 18: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 19: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 20: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 21: \ncase 27: " + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposMismoGrupoConNoMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); \n \t" + "obtenerlistaCamposMismoGrupoConNoMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigendos") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 22: \ncase 23: \ncase 24: \ncase 28: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposGruposMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 25: " + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposMismoGrupoConNoMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); \n \t" + "obtenerlistaCamposMismoGrupoConNoMultiples(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigendos") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 26: " + campoValorNoVisible_local + campoRecalculableVisible_local + campoOrigenUnoVisible_local + campoFormatoOrigenUnoVisible_local + campoOrigenDosVisible_local + campoFormatoOrigenDosVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposNumericosMismoGrupo(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigenuno") + "); \n \t" + "obtenerlistaCamposNumericosMismoGrupo(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampoorigendos") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 29: " + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposHoraAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";
            javascriptValidarConfiguracion_local += "case 29: \ncase 30: \ncase 31: \ncase 32: \ncase 33: \ncase 34: \ncase 35: \ncase 36: \ncase 37: \ncase 38: \ncase 39: \ncase 40: \ncase 41: \ncase 42: \n" + campoValorVisible_local + campoRecalculableVisible_local + campoOrigenUnoNoVisible_local + campoFormatoOrigenUnoNoVisible_local + campoOrigenDosNoVisible_local + campoFormatoOrigenDosNoVisible_local + campoFormatoCampoCalculadoVisible_local + "obtenerlistaCamposFechaAplicacion(frmIncluir" + '.' + mc.convertirAMayusculas("fldidcampovalor") + "); break; \n";

            javascriptValidarConfiguracion_local += "} \n\n\t }catch(err) { alert(err);alert(window.navigator.userAgent);} \n } \n";
        }
        catch (Exception excepcion)
        {
            excepcion.printStackTrace();
    ...
    protected String obtenerBloqueHeadPagina(ListaCampo pListaCampo, String pNombreFormulario, int pNivelesAnterioresDirectorio, boolean pExisteActuacion, boolean pEsSoloConsulta)
    {
        ...
        try
        {
            ...
            stringBuffer_local.append(gch_local.incluirLibreriaJavascript("../utilidades/javascript/", "sisnet.js?v=1.3.8", pNivelesAnterioresDirectorio));
...
private String obtenerEncabezadoPaginaSisnet(boolean pExisteConexion)
{
    ...
    try
    {
        ...
        encabezadoPagina_local = mc.concatenarCadena(encabezadoPagina_local, getGeneradorComponentesHtml().incluirLibreriaJavascript("../utilidades/javascript/", "sisnet.js?v=1.3.8", 0));
